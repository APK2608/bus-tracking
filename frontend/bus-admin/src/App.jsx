...
export default function App() {
  ...
  // Load the live bus fleet from the Express API on startup and keep it refreshed.
  useEffect(() => {
    loadBuses();
  ...
  const renderPage = () => {
    switch (currentPage) {
      case 'Buses':
        return <Buses buses={buses} setBuses={setBuses} refreshBuses={loadBuses} />;
      case 'Dashboard':
      default:
  ...
  if (!isLoggedIn) {
    return (
      <Login
        onLogin={(email, token) => {
          // sessionStorage is already updated by Login component;
